...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    /**
     * Dependency provider for <b>anychart</b> with <b>com.github.AnyChart:AnyChart-Android</b> coordinates and
     * with version reference <b>anychart</b>
     * <p>
     ...
     */
    @Deprecated
    public Provider<MinimalExternalModuleDependency> getAnychart() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return create("anychart");
    }
    ...
    /**
     * Group of libraries at <b>mediapipe</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
     ...
     */
    @Deprecated
    public static class MediapipeLibraryAccessors extends SubDependencyFactory {
        private final MediapipeTasksLibraryAccessors laccForMediapipeTasksLibraryAccessors = new MediapipeTasksLibraryAccessors(owner);

        public MediapipeLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>mediapipe.tasks</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public MediapipeTasksLibraryAccessors getTasks() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForMediapipeTasksLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class MediapipeTasksLibraryAccessors extends SubDependencyFactory {

        public MediapipeTasksLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>vision</b> with <b>com.google.mediapipe:tasks-vision</b> coordinates and
         * with version reference <b>mediapipe</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getVision() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("mediapipe.tasks.vision");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>anychart</b> with value <b>1.1.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getAnychart() { return getVersion("anychart"); }
        ...
        /**
         * Version alias <b>camerax</b> with value <b>1.2.0-alpha02</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>firebase</b> with value <b>33.1.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>google</b> with value <b>4.4.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>mediapipe</b> with value <b>0.10.14</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class GooglePluginAccessors extends PluginFactory {
         ...
         * with version reference <b>google</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
