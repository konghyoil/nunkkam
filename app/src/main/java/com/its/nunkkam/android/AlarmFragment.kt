...
class AlarmFragment : Fragment() {
    ...
    private fun switchToMeasurementAlarm() {
        btnMeasurementAlarm.setBackgroundColor(resources.getColor(R.color.background_teal))
        btnManageAlarm.setBackgroundColor(resources.getColor(R.color.black))
    ...
    private fun switchToManageAlarm() {
        btnManageAlarm.setBackgroundColor(resources.getColor(R.color.background_teal))
        btnMeasurementAlarm.setBackgroundColor(resources.getColor(R.color.black))
